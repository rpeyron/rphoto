...
[Setup]
AppName=RPhoto
AppVerName=RPhoto 0.4.4
AppPublisherURL=http://people.via.ecp.fr/~remi/soft/rphoto/
AppSupportURL=http://people.via.ecp.fr/~remi/soft/rphoto/
AppUpdatesURL=http://people.via.ecp.fr/~remi/soft/rphoto/
