...
#pragma interface "dirctrlg_fix.h"
#endif
...
class WXDLLEXPORT wxFixedDirFilterListCtrl;

class WXDLLEXPORT wxFixedDirCtrl: public wxControl
{
public:
    wxFixedDirCtrl();
    wxFixedDirCtrl(wxWindow *parent, const wxWindowID id = -1,
    ...
    virtual wxFixedDirFilterListCtrl* GetFilterListCtrl() const { return m_filterListCtrl; }
...
private:
    ...
    wxFixedDirFilterListCtrl* m_filterListCtrl;

private:
    DECLARE_EVENT_TABLE()
    DECLARE_DYNAMIC_CLASS(wxFixedDirCtrl)
};
...
class WXDLLEXPORT wxFixedDirFilterListCtrl: public wxChoice
{
public:
    wxFixedDirFilterListCtrl() { Init(); }
    wxFixedDirFilterListCtrl(wxFixedDirCtrl* parent, const wxWindowID id = -1,
              const wxPoint& pos = wxDefaultPosition,
              const wxSize& size = wxDefaultSize,
              long style = 0)
    {
    ...
    bool Create(wxFixedDirCtrl* parent, const wxWindowID id = -1,
              const wxPoint& pos = wxDefaultPosition,
              const wxSize& size = wxDefaultSize,
              long style = 0);
...
protected:
    wxFixedDirCtrl*    m_dirCtrl;

    DECLARE_EVENT_TABLE()
    DECLARE_CLASS(wxFixedDirFilterListCtrl)
};
